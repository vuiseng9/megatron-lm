...
class TokenDispatcher(torch.nn.Module):
    ...
    def __init__(
        ...
        self._in_splits = symm_mem.empty(self.nsplits, dtype=torch.int64, device=device)
        ...
        self.handles = {
            ...
            "_in_splits": symm_mem.rendezvous(self._in_splits, group=group.group_name),
    ...
    def forward(
        ...
        self._in_splits.copy_(in_splits)
        self._out.fill_(-1)
